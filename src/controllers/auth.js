...
exports.register = async (req, res) => {
    ...
    //    console.log(process.env.CLOUD_NAME)
        ...
        return res.status(401).json({message: 'Password and confirm password not the same'});
//
        // async function registerError (user, userP, userN){
        //     // user ? emailused = "email address" : emailused=""
        //     // userN ? phoneused = "phone number" : phoneused=""
        //     // userP ? nameused = "username" : nameused=""
        //     // if (userP) {phoneused="phone number"}
        //     // else{emailused=""}
        //     // if (userN) {nameused= "username"}
        //     // else{emailused=""}
        //     if (user!==null ||userN!==null || userP!==null )
        //     return res.status(401).json({message: `The ${emailused},${phoneused},${nameused} you have entered is already associated with another account.`});
        // }
        // registerError()
    //    
